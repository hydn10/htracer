#ifndef HTRACER_BENCHMARKS_CLI_STRUCTURE_SCHEMA_OBJECT_INPUT_HPP
#define HTRACER_BENCHMARKS_CLI_STRUCTURE_SCHEMA_OBJECT_INPUT_HPP
...
object_input<Result, InputSet>::evaluate(detail::parsing::parsed_arguments const &parsed, std::string_view path) const
{
