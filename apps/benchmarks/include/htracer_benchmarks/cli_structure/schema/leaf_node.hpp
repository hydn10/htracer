#ifndef HTRACER_BENCHMARKS_CLI_STRUCTURE_SCHEMA_LEAF_NODE_HPP
#define HTRACER_BENCHMARKS_CLI_STRUCTURE_SCHEMA_LEAF_NODE_HPP
    ...
    detail::parsing::argument_view arguments, std::string_view path, std::string_view description) const
{
  ...
  auto const parsed = detail::parsing::parse_options(arguments, values_.descriptors(), path);
