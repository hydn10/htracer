#ifndef HTRACER_BENCHMARKS_CLI_STRUCTURE_APPLICATION_HPP
#define HTRACER_BENCHMARKS_CLI_STRUCTURE_APPLICATION_HPP
...
{
  return root_.template parse<invocation_type>(detail::parsing::argument_view{arguments}, std::string{root_.name()});
}
