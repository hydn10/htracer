...
template<
    ...
    template<typename>
    typename... Geometries>
randomized_renderer<Float, Batcher, Sensor, Lens, Geometries...>::randomized_renderer(
    Batcher const &batcher,
    staging::scene<Float, Geometries...> const &scene,
    camera<Float> const &camera,
    Sensor const &sensor,
...
template<typename ExPolicy, typename GeneratorProvider>
image<Float>
randomized_renderer<Float, Batcher, Sensor, Lens, Geometries...>::render(
...
template<typename ExPolicy>
image<Float>
randomized_renderer<Float, Batcher, Sensor, Lens, Geometries...>::render(ExPolicy &&policy, uint32_t num_samples) const
{
